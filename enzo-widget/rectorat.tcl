...
label .example -font {"utah mt" 13 {bold} } -text "IP адреса группы Ректорат"
...
fill_headers $t
$t tag config colored -bg lightblue -font {"utah mt" 10 {bold} }
$t tag config title -fg black -font {"utah mt" 10 {bold} }
$t tag config active -bg darkred -fg snow -relief solid
$t tag config title -fg white -bg black -font {"utah mt" 12 {bold} }
$t width 0 3
$t set  1,2 "010.005.009.001" \
	1,3 "комната № 009" \
	1,1 "Комарницкий Виталий Марьянович" \
	2,2 "010.005.027.001" \
	2,3 "комната № 027" \
	2,1 "Виленская Элеонора Владимировна" \
	3,2 "010.005.029.001" \
	3,3 "комната № 029" \
	3,1 "Форостюк Олег Дмитриевич" \
	4,2 "010.005.030.001" \
	4,3 "комната № 030" \
	4,1 "Левченков Александр Иванович" \
	5,2 "010.005.032.001" \
	5,3 "комната № 032" \
	5,1 "Новаков Александр Сергеевич" \
	6,2 "010.005.043.001" \
	6,3 "комната № 042" \
	6,1 "Гаврик Сергей Юрьевич" \
